...
<div class="login-reg-panel">
    ...
    <div class="register-info-box">
      <h2 style="color: white;margin-top: 80px;margin-right: 30px">New password?</h2>
   <br>
    ...
    <div class="white-panel">
      <div class="login-show">
       <form class="login-form" action="app_logic.php?email=<?php echo $_GET['email'] ?>" method="post">
		...
		<div class="form-group">
			...
			<input type="submit" name="new_password" class="login-btn" style="background-color: red; color: white">
		</div>
	</form>
      </div>
    </div>
